...
const Hero = () => {
  return (
    <div className="relative">
      ...
      <Header />
      <div className="">
                  <h1 className='font-normal text-center max-w-[718px] mx-auto text-4xl md:text-5xl lg:text-custom-2xl !leading-custom-lg text-white'>Unlock Knowledge with Our <span className='text-light-green font-semibold'>Featured Articles</span></h1>
